...
from flare.modules import NJF_MeshProcessor as MeshProcessor
...
class SourceMesh:
    ...
    def __init__(self, source_ind, source_dir, extra_source_fields,
                 random_scale, ttype=torch.float32, use_wks=False, random_centering=False,
                cpuonly=False):
    ...
    def __init_from_mesh_data(self):
        ...
        # start = time.time()
        centroids = self.mesh_processor.get_centroids(self.__use_wks)
