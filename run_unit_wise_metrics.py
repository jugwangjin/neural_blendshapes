...
def main():
    ...
    exps_dir = os.path.join('/Bean/log/gwangjin/2025/nbshapes_unit_wise/')
    save_dir = 'figures/metrics_unit_wise'
    ...
    for directory in os.listdir(data_dir):
        ...
        images_dir = os.path.join(exps_dir, 'v1', directory, 'images_evaluation', 'qualitative_results', 'rgb')
