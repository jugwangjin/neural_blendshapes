...
def track_image(image_path, mediapipe, tstamp):
        ...
        face_landmarker_result = mediapipe.detect_for_video(mp_image, tstamp)
...
def main(args, device, dataset_train, dataloader_train, debug_views):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        for i in range(frame_count):
            ...
            # how do I get the timestamp of this frame?
            ...
            # as milisecond
            tstamp = frame_timestamp_ms


            mp_blendshape, mp_transform_matrix = track_image(f'{tmpdir}/tmp.png', mediapipe, tstamp)
