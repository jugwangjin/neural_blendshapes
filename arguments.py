...
def config_parser():
    ...
    parser.add_argument('--save_frequency', type=int, default=500, help="Frequency of mesh and shader saving (in iterations)")
    parser.add_argument('--visualization_frequency', type=int, default=500, help="Frequency of shader visualization (in iterations)")
    ...
    parser.add_argument('--weight_linearity_regularization', type=float, default=1e-6, help="Weight of the flame term")
