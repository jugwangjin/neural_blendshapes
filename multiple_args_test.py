...
if __name__ == '__main__':
    ...
    #  --iterations == 1000
    params_list = ["landmark", "closure", "mask", "segmentation", "shading", "perceptual_loss", 'normal_regularization']
    ...
    for i in range(len(params_list)):
        ...
        #         os.system(command)
        command = f"CUDA_VISIBLE_DEVICES={i} " + base_command + f" --run_name large_steps_{params_list[i]}_0 --wandb_name {params_list[i]}_0 --weight_{params_list[i]} 0 --iterations 500 &"
