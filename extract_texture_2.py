...
def create_position_map(mesh, uv_coords, uv_idx, canonical_v, output_path, size=512):
    ...
    pcd.points = o3d.utility.Vector3dVector(uv_map.reshape(-1, 3))
    o3d.io.write_point_cloud(f'debug/texture_map/{args.model_name}.ply', pcd)
...
def main(args, device):
    ...
    os.makedirs('debug/texture_map', exist_ok=True)
