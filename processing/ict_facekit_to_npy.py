...
def main(args):
    ...
    ict_model_dict = {}
    ict_model_dict['neutral_mesh'] = new_vertices
    ict_model_dict['faces'] = new_faces
    ...
    ict_model_dict['expression_shape_modes'] = ict_expression_shape_modes[:, vmapping]
    ict_model_dict['identity_shape_modes'] = ict_identity_shape_modes[:, vmapping]
