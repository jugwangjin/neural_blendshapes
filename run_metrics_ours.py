...
def main():
    ...
    exps_dir = os.path.join('/Bean/log/gwangjin/2025/nbshapes_iccv_unit_wise/')
    ...
    for directory in os.listdir(data_dir):
        ...
        images_dir = os.path.join(exps_dir, directory, 'images_evaluation', 'qualitative_results', 'rgb')

        if not os.path.exists(images_dir):
            continue

        name = 'ours_iccv_unit_wise_' + directory
