...
if __name__ == '__main__':
    ...
    dataset_train    = DatasetLoader(args2, train_dir=args.train_dir, sample_ratio=100, pre_load=False, train=True)
    dataset_val      = DatasetLoader(args2, train_dir=args.eval_dir, sample_ratio=100, pre_load=False)
